    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/agesa3/androidtemplate/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/agesa3/androidtemplate.git")
                    developerConnection.set("scm:git:ssh://github.com/agesa3/androidtemplate.git")
                    url.set("https://github.com/agesa3/androidtemplate/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/agesa3/androidtemplate/issues")
                }
            }
        }
    }
